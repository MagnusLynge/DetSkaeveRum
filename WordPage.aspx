                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12" style="padding-top: 15px;">
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtWord" CssClass="input-sm" Placeholder="Indtast ord" runat="server" Width="350px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="well-lg" style="width: 100%; text-align: center; -webkit-box-shadow: 0px 8px 12px 0px rgba(50, 50, 50, 0.75); -moz-box-shadow: 0px 8px 12px 0px rgba(50, 50, 50, 0.75); box-shadow: 0px 8px 12px 0px rgba(50, 50, 50, 0.75);">
                    <asp:Repeater ID="RepeaterWord" runat="server">
                        <ItemTemplate>
                            <asp:Label ID="lblWord" runat="server" Font-Bold="True" Text='<%#Eval("Word1")%>'></asp:Label><br /><hr/>
                        </ItemTemplate>
                    </asp:Repeater>
                </div>
            </div>
